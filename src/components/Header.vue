...
<template>
    <!-- Desktop Header -->
    <header class="hidden lg:block bg-white z-10 fixed w-full top-0 border-b border-gray-200 px-2 py-3">
        <div class="max-w-screen-2xl mx-auto flex flex-row justify-between items-center">
            ...
            <div class="w-1/2 mx-8 relative flex">
                ...
                <div
                    ...
                    <svg class="text-white w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
            ...
            <nav class="flex flex-row items-center gap-6">
                ...
                <!-- Profile -->
                <div class="relative">
                    <div class="cursor-pointer hover:contrast-75 w-10 h-10 rounded-full overflow-hidden">
