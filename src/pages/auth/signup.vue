...
<template>
    <f7-page name="signup" class="auth-container">
        ...
        <div>
            <div class="mx-auto max-w-screen-2xl px-0 lg:px-8">
                <f7-list class="lg:bg-white mx-auto max-w-lg lg:rounded-lg lg:border">
                    <f7-block>
                        <f7-nav-left back-link="Back" class="mb-3"></f7-nav-left>
                        <h3 class="auth-title text-clr-primary text-3xl font-semibold w-5/6">Hello! Register to get started!
                        </h3>
                    </f7-block>
                    <!-- Form -->
                    <form class="auth-form">
                        ...
                        <f7-list-input outline label="Confirm Password" floating-label type="password"
                            clear-button>
                        </f7-list-input>
                        <f7-block>
                            <f7-list-button class="list-none auth-btn">Register</f7-list-button>
                        </f7-block>
                    </form>
                    ...
                    <div class="flex items-center justify-center lg:bg-gray-100 p-4 mt-2 lg:mt-5">
                        <p class="text-center text-sm text-gray-500">Already have an account? <a href="/login"
                                class="text-clr-primary font-medium">Sign in</a>
                        </p>
                    </div>
                </f7-list>
            </div>
